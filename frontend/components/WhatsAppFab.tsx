...
/**
 * Always-visible WhatsApp escape hatch. If someone can't finish the online
 * form, they should still be able to reach a human in one tap rather than
 * abandoning the site.
 *
 * Kept in the brand navy/gold rather than WhatsApp green so the site stays on
 * the logo's palette — the glyph is what makes it recognisable.
 */
export default function WhatsAppFab() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="واٹس ایپ پر رابطہ کریں"
      className="fixed bottom-5 left-5 z-50 flex items-center gap-2 rounded-full border border-gold bg-navy px-5 py-3 font-body text-sm text-white shadow-card transition hover:bg-navy-light focus:outline-none focus-visible:ring-2 focus-visible:ring-gold"
    >
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true" className="text-gold">
